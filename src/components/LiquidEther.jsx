...
const areEqual = (prevProps, nextProps) => {
  ...
  for (let i = 0; i < prevProps.colors.length; i++) {
    if (prevProps.colors[i] !== nextProps.colors[i]) return false;
  }
  return (
    prevProps.mouseForce === nextProps.mouseForce &&
    prevProps.cursorSize === nextProps.cursorSize &&
    prevProps.isViscous === nextProps.isViscous &&
    prevProps.viscous === nextProps.viscous &&
    prevProps.iterationsViscous === nextProps.iterationsViscous &&
    prevProps.iterationsPoisson === nextProps.iterationsPoisson &&
    prevProps.dt === nextProps.dt &&
    prevProps.BFECC === nextProps.BFECC &&
    prevProps.resolution === nextProps.resolution &&
    prevProps.isBounce === nextProps.isBounce &&
    prevProps.autoDemo === nextProps.autoDemo &&
    prevProps.autoSpeed === nextProps.autoSpeed &&
    prevProps.autoIntensity === nextProps.autoIntensity &&
    prevProps.takeoverDuration === nextProps.takeoverDuration &&
    prevProps.autoResumeDelay === nextProps.autoResumeDelay &&
    prevProps.autoRampDuration === nextProps.autoRampDuration
  );
};

export default memo(LiquidEther, areEqual);
